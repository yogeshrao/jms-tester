...
REM Set jvm memory configuration
 IF DEFINED JMSTESTER_OPTS_MEMORY (
	ECHO "HERE !!"
    REM set JMSTESTER_OPTS_MEMORY= "-Xms256M -Xmx256M"
 ) else (
